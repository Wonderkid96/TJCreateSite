...
export default function Contact() {
  return (
    <section
      ...
      className="contact-section relative flex w-full flex-col justify-center overflow-hidden bg-ink px-6 py-16 text-paper md:px-10 md:py-20"
    >
      ...
      >
        <motion.h2
          ...
          className="font-display uppercase text-[clamp(2.5rem,7vw,6rem)] leading-[0.95] tracking-tight transition-colors group-hover:text-accent"
        >
