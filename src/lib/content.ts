...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    video: "/work/imported/motion/liar-liar-out-now.mp4",
    videoPoster: "/work/imported/posters-video/liar-liar-out-now.avif",
  ...
  },
  {
    ...
    blurb:
      "Product animation for Pulse Audio's in-ear headphones. Sculpted, textured, lit and animated in Blender, composited in After Effects. A slow rotating cycle that lets the form and materials carry the piece.",
    video: "/work/imported/motion/headphone-animation.mp4",
    videoPoster: "/work/imported/projects/headphone-render.avif",
...
export const SERVICES = [
  {
    ...
    blurb:
      "Identity, print and campaign artwork for brands, products and events. Posters, packaging, editorial, digital and social, built to stay consistent wherever they land, from a shop shelf to a feed.",
    items: [
      "Brand identity",
      "Campaign artwork",
      "Posters & print",
  ...
  },
  {
    ...
    blurb:
      "Motion built to carry an idea beyond the static. Title sequences, promos, lyric videos, social content and campaign assets, with animation, typography, compositing and 3D brought together where the job needs it.",
    items: [
      "Motion design",
      "2D animation",
      "Animated typography",
  ...
  },
  {
    title: "3D Design",
    blurb:
      "Product visualisation, modelling, materials, lighting and animation for campaigns that need more than supplied photography. From standalone product renders to fully built scenes, packaging visuals and motion.",
    items: [
      "3D modelling",
